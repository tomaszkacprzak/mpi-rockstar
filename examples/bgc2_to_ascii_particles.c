...
int main(int argc, char **argv) {
    ...
    printf("#X Y Z VX VY VZ ParticleID IsSubstructure HaloID HaloParent\n");
    printf("#Units: positions in Mpc/h (comoving)\n");
    printf("#Units: velocities in km/s (non-comoving)\n");
    printf("#IsSubstructure: 1 if the particle belongs to substructure within "
           "the halo; 0 otherwise\n");
    ...
    for (i = 1; i < argc; i++) {
        ...
        for (; k < num_parts; k++) {
            ...
            printf("%f %f %f %f %f %f %" PRId64 " %" PRId64 " %" PRId64
                   " %" PRId64 "\n",
