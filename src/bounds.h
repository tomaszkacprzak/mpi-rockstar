...
void    render_ccache(int64_t *ccache, int64_t ccache_size, float *bounds,
                      float *ccache_bounds, int64_t val);
int64_t check_ccache(int64_t *ccache, int64_t ccache_size, float *pos,
                     float *ccache_bounds);
