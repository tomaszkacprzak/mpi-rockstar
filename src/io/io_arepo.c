...
void arepo_readheader_array(hid_t HDF_GroupID, char *filename, char *objName,
...
void load_particles_arepo(char *filename, struct particle **p, int64_t *num_p) {
    ...
    arepo_readheader_array(HDF_Header, filename, "NumPart_Total_HighWord",
                           H5T_NATIVE_UINT32, npart_high);
    arepo_readheader_array(HDF_Header, filename, "NumPart_Total",
                           H5T_NATIVE_UINT32, npart_low);
